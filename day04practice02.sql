...
create table ogrenci_info(
    ogr_id int primary key, --UNİQU VE NOT NULL
...
insert into ogrenci_info(ogr_id, ogr_yas, ogr_isim) 
values(109,6,'JOHN WALKER');
...
--SORU2: JOHN WALKER'ın , 
--ogr_kayit sütununu 11-12-1997 değeriyle değiştiriniz.
UPDATE ogrenci_info
...
update ogrenci_info
set ogr_kayit='11-4-1996',
    ogr_isim='MARK TWAIN'
where ogr_id=105;	

--SORU4: id'si 106'dan küçük tüm ogr_kayit 
--değerlerini 01-08-2021'e güncelle.
update ogrenci_info
...
delete from insanlar
where adres <> 'Florida';
--!= sqlde bunun yerine <> isaretini kullanırız

...
--2. Yol : in ==> Birden fazla ifade ile tanimlayabilecegimiz durumlari in komutu ile yazabiliriz.
...
update film set film_turu='Komedi' ,  film_ismi='Cakallarla Dans' where film_no=100
select * from film;
delete from film;
